...
def _design_loop_corridor(
    ...
    """
    # road_factor: real road distance is ~1.6x the straight-line circumference
    # for rural/mountain cycling corridors. A larger factor widens the corridor
    # so Mapbox routes a proper loop rather than cutting back across the origin.
